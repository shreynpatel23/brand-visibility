  ...
  const features = [
    {
      ...
      description: "Track your brand visibility across ChatGPT, Claude, and Gemini with live performance metrics."
    },
    {
      icon: <Target className="w-6 h-6" />,
      title: "Funnel Analysis",
      description: "Monitor TOFU, MOFU, BOFU, and EVFU stages to understand your brand's customer journey impact."
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: "Sentiment Tracking",
      description: "Analyze positive, neutral, and negative sentiment trends to optimize your brand positioning."
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Team Collaboration",
      description: "Invite team members with role-based access to collaborate on brand visibility strategies."
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Competitive Intelligence",
      description: "Compare your brand performance against competitors across different AI models."
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Automated Monitoring",
      description: "Set up automated prompt executions to continuously monitor your brand visibility."
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "BrandViz transformed how we understand our AI visibility. We increased our brand mentions by 340% in just 3 months.",
      rating: 5
    },
    {
      ...
      content: "The funnel analysis feature helped us identify gaps in our MOFU strategy. Our conversion rates improved significantly.",
      rating: 5
    },
    {
      name: "Emily Watson",
      ...
      content: "Finally, a tool that shows us how AI models perceive our brand. The insights are invaluable for our positioning strategy.",
      rating: 5
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              to improve your visibility across AI models and drive better business outcomes.
            </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-900 dark:to-blue-900 p-6 rounded-lg">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-gray-900 dark:text-white">TechCorp</h3>
                    <span className="text-sm text-gray-500 dark:text-gray-400">Technology</span>
                  </div>
                  <div className="grid grid-cols-4 gap-2 mb-4">
                    <div className="bg-green-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">85%</div>
                    <div className="bg-yellow-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">72%</div>
                    <div className="bg-orange-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">68%</div>
                    <div className="bg-green-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">91%</div>
                  </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900 dark:to-emerald-900 p-6 rounded-lg">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-gray-900 dark:text-white">HealthPlus</h3>
                    <span className="text-sm text-gray-500 dark:text-gray-400">Healthcare</span>
                  </div>
                  <div className="grid grid-cols-4 gap-2 mb-4">
                    <div className="bg-yellow-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">78%</div>
                    <div className="bg-green-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">81%</div>
                    <div className="bg-yellow-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">75%</div>
                    <div className="bg-green-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">83%</div>
                  </div>
                  <div className="flex items-center text-sm text-green-600 dark:text-green-400">
                    <TrendingUp className="w-4 h-4 mr-1" />
                    +8% this month
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900 dark:to-pink-900 p-6 rounded-lg">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-gray-900 dark:text-white">EduLearn</h3>
                    <span className="text-sm text-gray-500 dark:text-gray-400">Education</span>
                  </div>
                  <div className="grid grid-cols-4 gap-2 mb-4">
                    <div className="bg-green-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">92%</div>
                    <div className="bg-green-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">88%</div>
                    <div className="bg-green-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">85%</div>
                    <div className="bg-yellow-500 h-8 rounded flex items-center justify-center text-white text-xs font-bold">79%</div>
                  </div>
                  <div className="flex items-center text-sm text-green-600 dark:text-green-400">
                    <TrendingUp className="w-4 h-4 mr-1" />
                    +15% this month
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Comprehensive tools to monitor, analyze, and optimize your brand's presence across AI models.
            </p>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Track your brand's visibility across AI models and optimize your digital presence.
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2024 BrandViz. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
